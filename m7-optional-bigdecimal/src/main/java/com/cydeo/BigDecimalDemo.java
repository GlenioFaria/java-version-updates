...
public class BigDecimalDemo {
    ...
    public static void main(String[] args) {
        ...
        BigDecimal b1 = new BigDecimal("374.560");
        BigDecimal b2 = new BigDecimal("374.260");
        ...
        System.out.println(b1.multiply(new BigDecimal("25.00")));
        System.out.println(b1.multiply(BigDecimal.valueOf(15.56)));

        //Scaling
        BigDecimal number1 = new BigDecimal("23.12");
        System.out.println(number1.setScale(0, RoundingMode.CEILING));
        System.out.println(number1.setScale(0, RoundingMode.FLOOR));
